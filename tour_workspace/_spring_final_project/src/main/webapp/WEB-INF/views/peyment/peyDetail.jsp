...
<script type="text/javascript">
	let pkNo = `<c:out value="${packvo.pkNo}" />`;
	let pkName = `<c:out value="${packvo.pkName}" />`;
	let pkPrice = `<c:out value="${packvo.pkPrice}" />`;
	let pkContinent = `<c:out value="${packvo.pkContinent}" />`;
	let pkContent = `<c:out value="${packvo.pkContent}" />`;
	let id = `<c:out value="${uvo.id}" />`;
	let email =  `<c:out value="${uvo.email}" />`;
	let Username =  `<c:out value="${uvo.name}" />`;
	let phoneNumber = `<c:out value="${uvo.phoneNumber}" />`;
	let point = `<c:out value="${memShp.point}" />`;
	let grade = `<c:out value="${memShp.grade}" />`;
	let userCount = `<c:out value="${userCount}" />`;
